        ...
        return (
            <View style={styles.container}>
              <Image
                ...
                source={require('./assets/images/logo-login.gif')}
                resizeMode="contain"
              />
        
              <Text style={{ fontSize: 40, fontWeight: 'bold' }}> Covid+</Text>
              <Text style={{ fontSize: 16, color: 'gray', textAlign: 'center', marginHorizontal: 20 }}> Saiba sobre os dados do covid!</Text>
              ...
              <View style={{ flexDirection: 'row', margin: 20, paddingVertical: 20 }}>
                ...
                >
                  <Text style={{ textAlign: 'center', color: '#0d47a1', fontSize: 18 }}>Cadastre-se</Text>
                </TouchableOpacity>
